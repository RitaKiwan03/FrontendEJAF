      ...
      >
        ...
        <div className="absolute inset-0">
          <div className="absolute left-1/2 top-[52%] h-[28rem] w-[28rem] -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-full md:h-[32rem] md:w-[32rem]">
            ...
            <motion.div
              className="absolute inset-0 grid grid-cols-10 gap-x-5 overflow-hidden font-mono text-[clamp(1rem,1.35vw,1.4rem)] font-medium tracking-[0.35em] text-slate-300/35 [mask-image:radial-gradient(circle,black_58%,transparent_100%)] [mask-repeat:no-repeat] [mask-size:100%_100%] [-webkit-mask-image:radial-gradient(circle,black_58%,transparent_100%)] [-webkit-mask-repeat:no-repeat] [-webkit-mask-size:100%_100%]"
